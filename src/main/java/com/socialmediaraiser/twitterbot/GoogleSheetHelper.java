...
public class GoogleSheetHelper extends AbstractIOHelper {
  ...
  public boolean shouldBeTaken(boolean showFalse, boolean showTrue, List<Object> valueArray, int followBackResultIndex) {
    return ((showFalse && showTrue)
            ...
            || (valueArray.size() > followBackResultIndex && showFalse && String.valueOf(valueArray.get(followBackResultIndex))
                                                                                .equalsIgnoreCase("false"))
            || (valueArray.size() > followBackResultIndex && showTrue && String.valueOf(valueArray.get(followBackResultIndex))
